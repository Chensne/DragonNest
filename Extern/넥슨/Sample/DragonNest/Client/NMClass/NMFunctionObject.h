...
public:
	...
	CNMCharacterLoginFunc( LPCTSTR szUserId, _UInt32_ uVirtualIdCode, INT32 nServerCode );
...
public:
	...
	CNMCharacterLogoutFunc( LPCTSTR szUserId, _UInt32_ uVirtualIdCode, INT32 nServerCode );
