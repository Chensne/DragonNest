...
enum	NMLOCALCONFIGTYPE
{
	...
	kLocalConfig_End				= kLocalConfig_FilterOtherMessage,
...
enum
{
	...
	kGameCode_combatarms_us				= MAKE_GAMECODE( kMainGameCode_nexonus		, kSubGameCode_combatarms ),
	...
	kGameCode_cso_tw					= MAKE_GAMECODE( kMainGameCode_nexontw		, kSubGameCode_cso ),
	...
	kGameCode_neo						= MAKE_GAMECODE( kMainGameCode_nexoncom		, kSubGameCode_neo ),
	...
	kGameCode_koongpa_cn				= MAKE_GAMECODE( kMainGameCode_nexoncn		, kSubGameCode_koongpa ),
	...
	kGameCode_projectmv					= MAKE_GAMECODE( kMainGameCode_nexoncom		, kSubGameCode_projectmv ),
	...
	kGameCode_motoloco					= MAKE_GAMECODE( kMainGameCode_nexonus		, kSubGameCode_motoloco ),
	kGameCode_sugarrush					= MAKE_GAMECODE( kMainGameCode_nexonus		, kSubGameCode_sugarrush ),
	kGameCode_nxopp						= MAKE_GAMECODE( kMainGameCode_nexonus		, kSubGameCode_nxopp ),
...
public:
	...
	{
		this->flag &= ~( bEnabled ? 0 : Flag_ReceiveMessage );
	}
