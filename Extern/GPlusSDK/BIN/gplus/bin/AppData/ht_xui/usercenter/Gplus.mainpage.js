var GIndexMgr = {
    ...
    indexLoad: function(source, callback) {
        ...
        var newstitle = $("<div class=\"title\"><a href=\"javascript:void(0)\">查看全部消息</a>未读消息</div>");
        ...
        if (source) {
            ...
            if (source.length > 0) {
                ...
                if (num == 0) {
                    container.append($("<div>暂时没有消息</<div>"));
                }
    ...
    changenamedialog: function() {
        ...
        html += "<td height=\"40\" colspan=\"2\"><input name=\"textfield22\" type=\"text\" class=\"namep namep165\" value=\"" + CurrentLoginUserNickName + "\" />&nbsp;<a href=\"javascript:void(0)\" class=\"tit\"></a></td>";
        html += "</tr>";
        html += "<tr>";
