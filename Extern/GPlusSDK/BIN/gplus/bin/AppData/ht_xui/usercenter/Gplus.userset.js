var setandfeed = {
    ...
    bindtransparency: function(container) {
        ...
        slider.find(".Perce").css({ "left": width });
    ...
    appendfeedbackdetail: function(container) {
        ...
        html += "<td width=\"89%\"><input onkeyup=\"setandfeed.EidtWordChanges(this,$('span[name=try1]'),30)\" name=\"textfield\" type=\"text\" class=\"namep namep300\" value=\"请输入标题\" /></td>";
        html += "</tr>";
        html += "<tr>";
