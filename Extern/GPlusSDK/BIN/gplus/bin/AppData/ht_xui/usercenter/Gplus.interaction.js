...
var ExternalIA =
{
    ...
    GoGmainPage: function(index, length, categories, callback) {
        ...
        CallFunWithCondition(function() {
            ...
            function() {
                ...
                //  ExternalIA.SendRequest(message, "GetMessageList", data, "GetMessageListNickCallBack", "", true);
                ExternalIA.SendRequest(message, "GetMessageCount", "", "GetMessageListNickCallBack", "", true);
    ...
    IsHaveName: function() {
        ...
        return true; //屏蔽虚名//CurrentLoginUserNickName != "" && CurrentLoginUserNickName.length > 0;
    },
...
function Other_ClearContainer(pageID, containerID) {
    ...
    //Global_CurrentRenderPageID = "";
    //Global_TotalAutoScoll = 0;
    //UserMgr.clearUserCollection();
    // ExternalIA.outerShowUserCard("hide", 0, "");
