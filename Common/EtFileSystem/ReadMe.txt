========================================================================
    정적 라이브러리 : CEtFileSystem 프로젝트 개요
========================================================================

응용 프로그램 마법사에서 이 CEtFileSystem 라이브러리 프로젝트를 만들었습니다. 
이 파일에는 CEtFileSystem 응용 프로그램을 구성하는 각각의 파일에
들어 있는 요약 설명이 포함되어 있습니다.


CEtFileSystem.vcproj
...
StdAfx.h 및 StdAfx.cpp는
    CEtFileSystem.pch라는 이름의 PCH(미리 컴파일된 헤더) 파일과
