...
*                                                                   *
*          File revision 1.0  (EAX 5.0 SDK Release)                 *
*                                                                   *
\*******************************************************************/
...
////////////////////////////////////////////////////////////////////////////
//
//    If an application wishes to support both EAX 4.0 and EAX 5.0
//    it can use the following pre-processor definition to include
//    all the EAX 4.0 GUIDs and Structures :-
//         _INCLUDE_EAX_40_DEFINITIONS
//    All EAX 4.0 GUIDS and Structures will include '40' in the name
//    e.g EAX40CONTEXTPROPERTIES for the EAX 4.0 Context Properties Structure
//        EAXPROPERTYID_EAX40_Context for the EAX 4.0 Context Object GUID
//
////////////////////////////////////////////////////////////////////////////
...
#define EAX50_MAX_FXSLOTS 4
#define EAX50_MAX_ACTIVE_FXSLOTS 4

#define EAX_MAX_FXSLOTS EAX50_MAX_FXSLOTS
#define EAX_MAX_ACTIVE_FXSLOTS EAX50_MAX_ACTIVE_FXSLOTS

#ifdef _INCLUDE_EAX_40_DEFINITIONS
#define EAX40_MAX_FXSLOTS 4
#define EAX40_MAX_ACTIVE_FXSLOTS 2
#endif
...
#ifndef EAX50SESSIONPROPERTIES_DEFINED
#define EAX50SESSIONPROPERTIES_DEFINED
...
#define EAXSESSIONPROPERTIES EAX50SESSIONPROPERTIES
#define LPEAXSESSIONPROPERTIES LPEAX50SESSIONPROPERTIES

#ifdef _INCLUDE_EAX_40_DEFINITIONS
// No equivalent in EAX 4.0
#endif

/////////////////////////////////////////////////////////
// Use this structure for EAXCONTEXT_ALL property.
#ifndef EAX50CONTEXTPROPERTIES_DEFINED
#define EAX50CONTEXTPROPERTIES_DEFINED
typedef struct _EAX50CONTEXTPROPERTIES
{
...
#define EAXCONTEXTPROPERTIES EAX50CONTEXTPROPERTIES
#define LPEAXCONTEXTPROPERTIES LPEAX50CONTEXTPROPERTIES

#ifdef _INCLUDE_EAX_40_DEFINITIONS
#ifndef EAX40CONTEXTPROPERTIES_DEFINED
#define EAX40CONTEXTPROPERTIES_DEFINED
typedef struct _EAX40CONTEXTPROPERTIES
{
    GUID          guidPrimaryFXSlotID;
    float         flDistanceFactor;
    float         flAirAbsorptionHF;
    float         flHFReference;
} EAX40CONTEXTPROPERTIES, *LPEAX40CONTEXTPROPERTIES;
#endif
#endif
...
//
#ifndef EAX50SOURCEPROPERTIES_DEFINED
#define EAX50SOURCEPROPERTIES_DEFINED
typedef struct _EAX50SOURCEPROPERTIES
{
	...
	float         flMacroFXFactor;         // controls the near-field effect
} EAX50SOURCEPROPERTIES, *LPEAX50SOURCEPROPERTIES;
#endif

#define EAXSOURCEPROPERTIES EAX50SOURCEPROPERTIES
#define LPEAXSOURCEPROPERTIES LPEAX50SOURCEPROPERTIES

#ifdef _INCLUDE_EAX_40_DEFINITIONS
#ifndef EAX40SOURCEPROPERTIES_DEFINED
#define EAX40SOURCEPROPERTIES_DEFINED
typedef struct _EAX40SOURCEPROPERTIES
{
    long          lDirect;                 // direct path level (at low and mid frequencies)
    long          lDirectHF;               // relative direct path level at high frequencies
    long          lRoom;                   // room effect level (at low and mid frequencies)
    ...
    float         flAirAbsorptionFactor;   // multiplies EAXREVERB_AIRABSORPTIONHF
    unsigned long ulFlags;                 // modifies the behavior of properties
} EAX40SOURCEPROPERTIES, *LPEAX40SOURCEPROPERTIES;
#endif
#endif
...
//              myBuffer = { 0, -200, ... , 0x00000003 };
//
#ifndef EAX50SOURCE2DPROPERTIES_DEFINED
#define EAX50SOURCE2DPROPERTIES_DEFINED
typedef struct _EAX50SOURCE2DPROPERTIES
{
    long          lDirect;                 // direct path level (at low and mid frequencies)
    long          lDirectHF;               // relative direct path level at high frequencies
    long          lRoom;                   // room effect level (at low and mid frequencies)
    long          lRoomHF;                 // relative room effect level at high frequencies
    unsigned long ulFlags;                 // modifies the behavior of properties
} EAX50SOURCE2DPROPERTIES, *LPEAX50SOURCE2DPROPERTIES;
#endif

#define EAXSOURCE2DPROPERTIES EAX50SOURCE2DPROPERTIES
#define LPEAXSOURCE2DPROPERTIES LPEAX50SOURCE2DPROPERTIES

#ifdef _INCLUDE_EAX_40_DEFINITIONS
// No EAX 4.0 Equivalent
#endif
...
// - all levels are hundredths of decibels
//
#ifndef EAX50SOURCEALLSENDPROPERTIES_DEFINED
#define EAX50SOURCEALLSENDPROPERTIES_DEFINED
typedef struct _EAX50SOURCEALLSENDPROPERTIES
{
...
} EAX50SOURCEALLSENDPROPERTIES, *LPEAX50SOURCEALLSENDPROPERTIES;
#endif

#define EAXSOURCEALLSENDPROPERTIES EAX50SOURCEALLSENDPROPERTIES
#define LPEAXSOURCEALLSENDPROPERTIES LPEAX50SOURCEALLSENDPROPERTIES

#ifdef _INCLUDE_EAX_40_DEFINITIONS
#define EAX40SOURCEALLSENDPROPERTIES EAXSOURCEALLSENDPROPERTIES
#define LPEAX40SOURCEALLSENDPROPERTIES LPEAXSOURCEALLSENDPROPERTIES
#endif
...
//
#ifndef EAX50SPEAKERLEVELPROPERTIES_DEFINED
#define EAX50SPEAKERLEVELPROPERTIES_DEFINED
typedef struct _EAX50SPEAKERLEVELPROPERTIES
{
      long lSpeakerID;
      long lLevel;
} EAX50SPEAKERLEVELPROPERTIES, *LPEAX50SPEAKERLEVELPROPERTIES;
#endif

#define EAXSPEAKERLEVELPROPERTIES EAX50SPEAKERLEVELPROPERTIES
#define LPEAXSPEAKERLEVELPROPERTIES LPEAX50SPEAKERLEVELPROPERTIES
...
//
#ifndef EAX50ACTIVEFXSLOTS_DEFINED
#define EAX50ACTIVEFXSLOTS_DEFINED
typedef struct _EAX50ACTIVEFXSLOTS
{
    GUID          guidActiveFXSlots[EAX_MAX_ACTIVE_FXSLOTS];
} EAX50ACTIVEFXSLOTS, *LPEAX50ACTIVEFXSLOTS;
#endif

#define EAXACTIVEFXSLOTS EAX50ACTIVEFXSLOTS
#define LPEAXACTIVEFXSLOTS LPEAX50ACTIVEFXSLOTS

#ifdef _INCLUDE_EAX_40_DEFINITIONS
#ifndef EAX40ACTIVEFXSLOTS_DEFINED
#define EAX40ACTIVEFXSLOTS_DEFINED
typedef struct _EAX40ACTIVEFXSLOTS
{
    GUID          guidActiveFXSlots[EAX40_MAX_ACTIVE_FXSLOTS];
} EAX40ACTIVEFXSLOTS, *LPEAX40ACTIVEFXSLOTS;
#endif
#endif
...
//
#ifndef EAX50OBSTRUCTIONPROPERTIES_DEFINED
#define EAX50OBSTRUCTIONPROPERTIES_DEFINED
typedef struct _EAX50OBSTRUCTIONPROPERTIES
{
    long          lObstruction;
    float         flObstructionLFRatio;
} EAX50OBSTRUCTIONPROPERTIES, *LPEAX50OBSTRUCTIONPROPERTIES;
#endif

#define EAXOBSTRUCTIONPROPERTIES EAX50OBSTRUCTIONPROPERTIES
#define LPEAXOBSTRUCTIONPROPERTIES LPEAX50OBSTRUCTIONPROPERTIES

#ifdef _INCLUDE_EAX_40_DEFINITIONS
#define EAX40OBSTRUCTIONPROPERTIES EAXOBSTRUCTIONPROPERTIES
#define LPEAX40OBSTRUCTIONPROPERTIES LPEAXOBSTRUCTIONPROPERTIES
#endif

/////////////////////////////////////////////////////////
// Use this structure for EAXSOURCE_OCCLUSIONPARAMETERS property.
//
#ifndef EAX50OCCLUSIONPROPERTIES_DEFINED
#define EAX50OCCLUSIONPROPERTIES_DEFINED
typedef struct _EAX50OCCLUSIONPROPERTIES
{
    long          lOcclusion;
    float         flOcclusionLFRatio;
    float         flOcclusionRoomRatio;
    float         flOcclusionDirectRatio;
} EAX50OCCLUSIONPROPERTIES, *LPEAX50OCCLUSIONPROPERTIES;
#endif

#define EAXOCCLUSIONPROPERTIES EAX50OCCLUSIONPROPERTIES
#define LPEAXOCCLUSIONPROPERTIES LPEAX50OCCLUSIONPROPERTIES

#ifdef _INCLUDE_EAX_40_DEFINITIONS
#define EAX40OCCLUSIONPROPERTIES EAXOCCLUSIONPROPERTIES
#define LPEAX40OCCLUSIONPROPERTIES LPEAXOCCLUSIONPROPERTIES
#endif

/////////////////////////////////////////////////////////
// Use this structure for EAXSOURCE_EXCLUSIONPARAMETERS property.
//
#ifndef EAX50EXCLUSIONPROPERTIES_DEFINED
#define EAX50EXCLUSIONPROPERTIES_DEFINED
typedef struct _EAX50EXCLUSIONPROPERTIES
{
    long          lExclusion;
    float         flExclusionLFRatio;
} EAX50EXCLUSIONPROPERTIES, *LPEAX50EXCLUSIONPROPERTIES;
#endif

#define EAXEXCLUSIONPROPERTIES EAX50EXCLUSIONPROPERTIES
#define LPEAXEXCLUSIONPROPERTIES LPEAX50EXCLUSIONPROPERTIES

#ifdef _INCLUDE_EAX_40_DEFINITIONS
#define EAX40EXCLUSIONPROPERTIES EAXEXCLUSIONPROPERTIES
#define LPEAX40EXCLUSIONPROPERTIES LPEAXEXCLUSIONPROPERTIES
#endif

/////////////////////////////////////////////////////////
// Use this structure for EAXSOURCE_SENDPARAMETERS properties.
//
#ifndef EAX50SOURCESENDPROPERTIES_DEFINED
#define EAX50SOURCESENDPROPERTIES_DEFINED
typedef struct _EAX50SOURCESENDPROPERTIES
{
    GUID          guidReceivingFXSlotID;
    long          lSend;
    long          lSendHF;
} EAX50SOURCESENDPROPERTIES, *LPEAX50SOURCESENDPROPERTIES;
#endif

#define EAXSOURCESENDPROPERTIES EAX50SOURCESENDPROPERTIES
#define LPEAXSOURCESENDPROPERTIES LPEAX50SOURCESENDPROPERTIES

#ifdef _INCLUDE_EAX_40_DEFINITIONS
#define EAX40SOURCESENDPROPERTIES EAXSOURCESENDPROPERTIES
#define LPEAX40SOURCESENDPROPERTIES LPEAXSOURCESENDPROPERTIES
#endif

/////////////////////////////////////////////////////////
// Use this structure for EAXSOURCE_OCCLUSIONSENDPARAMETERS 
//
#ifndef EAX50SOURCEOCCLUSIONSENDPROPERTIES_DEFINED
#define EAX50SOURCEOCCLUSIONSENDPROPERTIES_DEFINED
typedef struct _EAX50SOURCEOCCLUSIONSENDPROPERTIES
{
	GUID          guidReceivingFXSlotID;
	long          lOcclusion;
	float         flOcclusionLFRatio;
	float         flOcclusionRoomRatio;
	float         flOcclusionDirectRatio;
} EAX50SOURCEOCCLUSIONSENDPROPERTIES, *LPEAX50SOURCEOCCLUSIONSENDPROPERTIES;
#endif

#define EAXSOURCEOCCLUSIONSENDPROPERTIES EAX50SOURCEOCCLUSIONSENDPROPERTIES
#define LPEAXSOURCEOCCLUSIONSENDPROPERTIES LPEAX50SOURCEOCCLUSIONSENDPROPERTIES

#ifdef _INCLUDE_EAX_40_DEFINITIONS
#define EAX40SOURCEOCCLUSIONSENDPROPERTIES EAXSOURCEOCCLUSIONSENDPROPERTIES
#define LPEAX40SOURCEOCCLUSIONSENDPROPERTIES LPEAXSOURCEOCCLUSIONSENDPROPERTIES
#endif

/////////////////////////////////////////////////////////
// Use this structure for EAXSOURCE_EXCLUSIONSENDPARAMETERS
//
#ifndef EAX50SOURCEEXCLUSIONSENDPROPERTIES_DEFINED
#define EAX50SOURCEEXCLUSIONSENDPROPERTIES_DEFINED
typedef struct _EAX50SOURCEEXCLUSIONSENDPROPERTIES
{
	GUID          guidReceivingFXSlotID;
	long          lExclusion;
	float         flExclusionLFRatio;
} EAX50SOURCEEXCLUSIONSENDPROPERTIES, *LPEAX50SOURCEEXCLUSIONSENDPROPERTIES;
#endif

#define EAXSOURCEEXCLUSIONSENDPROPERTIES EAX50SOURCEEXCLUSIONSENDPROPERTIES
#define LPEAXSOURCEEXCLUSIONSENDPROPERTIES LPEAX50SOURCEEXCLUSIONSENDPROPERTIES

#ifdef _INCLUDE_EAX_40_DEFINITIONS
#define EAX40SOURCEEXCLUSIONSENDPROPERTIES EAXSOURCEEXCLUSIONSENDPROPERTIES
...
//
#ifndef EAX50FXSLOTPROPERTIES_DEFINED
#define EAX50FXSLOTPROPERTIES_DEFINED
typedef struct _EAX50FXSLOTPROPERTIES
{
	GUID          guidLoadEffect;
	long          lVolume;
	long          lLock;
	...
	long          lOcclusion;
	float         flOcclusionLFRatio;
} EAX50FXSLOTPROPERTIES, *LPEAX50FXSLOTPROPERTIES;
#endif

#define EAXFXSLOTPROPERTIES EAX50FXSLOTPROPERTIES
#define LPEAXFXSLOTPROPERTIES LPEAX50FXSLOTPROPERTIES

#ifdef _INCLUDE_EAX_40_DEFINITIONS
#ifndef EAX40FXSLOTPROPERTIES_DEFINED
#define EAX40FXSLOTPROPERTIES_DEFINED
typedef struct _EAX40FXSLOTPROPERTIES
{
	GUID          guidLoadEffect;
	long          lVolume;
	long          lLock;
	unsigned long ulFlags;
} EAX40FXSLOTPROPERTIES, *LPEAX40FXSLOTPROPERTIES;
#endif
#endif
...
#define EAXCONTEXT_DEFAULTPRIMARYFXSLOTID EAXPROPERTYID_EAX_FXSlot0
...
#ifdef _INCLUDE_EAX_40_DEFINITIONS
#define EAX40FXSLOTFLAGS_RESERVED    0xFFFFFFFE // reserved future use
#endif
...
#ifdef _INCLUDE_EAX_40_DEFINITIONS
#define EAX40FXSLOT_DEFAULTFLAGS               (EAXFXSLOTFLAGS_ENVIRONMENT)
#endif
...
#ifdef _INCLUDE_EAX_40_DEFINITIONS
#define EAX40SOURCEFLAGS_RESERVED            0xFFFFFFF8 // reserved future use
#endif
...
#ifdef _INCLUDE_EAX_40_DEFINITIONS
#define EAX40SOURCE_DEFAULTFLAGS              (EAXSOURCEFLAGS_DIRECTHFAUTO |       \
                                               EAXSOURCEFLAGS_ROOMAUTO     |       \
                                               EAXSOURCEFLAGS_ROOMHFAUTO  )
...
#ifdef _INCLUDE_EAX_40_DEFINITIONS
#define EAX40SOURCE_DEFAULTACTIVEFXSLOTID  {{ EAX_NULL_GUID.Data1, EAX_NULL_GUID.Data2, EAX_NULL_GUID.Data3, \
                                    EAX_NULL_GUID.Data4[0],EAX_NULL_GUID.Data4[1],EAX_NULL_GUID.Data4[2],\
                                    EAX_NULL_GUID.Data4[3],EAX_NULL_GUID.Data4[4],EAX_NULL_GUID.Data4[5],\
                                    EAX_NULL_GUID.Data4[6],EAX_NULL_GUID.Data4[7] },                       \
                                  { EAX_PrimaryFXSlotID.Data1, EAX_PrimaryFXSlotID.Data2, \
