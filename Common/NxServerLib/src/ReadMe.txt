========================================================================
    정적 라이브러리 : NxServerLib 프로젝트 개요
========================================================================

응용 프로그램 마법사에서 이 NxServerLib 라이브러리 프로젝트를 만들었습니다. 
이 파일에는 NxServerLib 응용 프로그램을 구성하는 각각의 파일에
...
StdAfx.h 및 StdAfx.cpp는
    NxServerLib.pch라는 이름의 PCH(미리 컴파일된 헤더) 파일과
