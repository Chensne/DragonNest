...
// CDnView
//////////////////////////////////////////////////////////////////////////
IMPLEMENT_DYNCREATE(CDnView, CView)
...
BEGIN_MESSAGE_MAP(CDnView, CView)
END_MESSAGE_MAP()

void CDnView::OnDraw(CDC* pDC)
{
...
#ifdef _DEBUG
void CDnView::AssertValid() const
{
	CView::AssertValid();
}

#ifndef _WIN32_WCE
void CDnView::Dump( CDumpContext& dc ) const
{
	CView::Dump( dc );
}
#endif
...
IMPLEMENT_DYNCREATE(CDnHtmlView, CHtmlView)

CDnHtmlView::CDnHtmlView()
{
}
...
void CDnHtmlView::DoDataExchange( CDataExchange* pDX )
{
	CHtmlView::DoDataExchange( pDX );
}

BEGIN_MESSAGE_MAP(CDnHtmlView, CHtmlView)
END_MESSAGE_MAP()

#ifdef _DEBUG
void CDnHtmlView::AssertValid() const
{
	CHtmlView::AssertValid();
}

void CDnHtmlView::Dump( CDumpContext& dc ) const
{
	CHtmlView::Dump(dc);
}
#endif //_DEBUG

void CDnHtmlView::OnNavigateError( LPCTSTR lpszURL, LPCTSTR lpszFrame, DWORD dwError, BOOL *pbCancel )
{
	this->Navigate( lpszURL );
}
...
CDHtmlViewSpec::CDHtmlViewSpec() : CHtmlView()
...
BOOL CDHtmlViewSpec::PreTranslateMessage(MSG* pMsg)
{
	...
	{
		OutputDebugString(L"Function key ignored\r\n");
		return true;
	}
	...
	{
		//Ctrl-N
		OutputDebugString(L"Ctrl-N ignored\r\n");
		return true;
	}
	//ban printing
	...
	{
		//Ctrl-P
		OutputDebugString(L"Ctrl-P ignored\r\n");
		return true;
	}
	...
	{
		//Ctrl-D
		OutputDebugString(L"Ctrl-D ignored\r\n");
		return true;
	}
	...
	{
		//Atl-Left
		OutputDebugString(L"Atl-Left ignored\r\n");
		return true;
	}
	...
	{
		//Atl-Right
		OutputDebugString(L"Atl-Right ignored\r\n");
		return true;
	}
