...
#ifndef dCSP_TIMED_REDRAW
    SetTimer((UINT)(UINT_PTR) this, 500, NULL); // Use object's unique address as timer identifier
#else
...
// B..... Create a CStatic object upon the target status bar pane
    ...
    poStrClass = AfxRegisterWndClass(nClassStyle, AfxGetApp()->LoadStandardCursor(IDC_ARROW));
    bSuccess   = CStatic::CreateEx(nStyleEx, poStrClass, _T(""), nStyle, oRectPane, poStatusBar, (UINT)(UINT_PTR) this); // Use object's unique address as child window identifier
...
// B..... Create a CStatic object upon the target CWnd progress bar pane
  ...
  (
    ...
    (UINT)(UINT_PTR) this // Use object's unique address as child window identifier
  );
...
// B..... Delete the refresh timer
  ...
  {
    KillTimer((UINT)(UINT_PTR) this); // Use object's unique address as timer identifier
  }else{}
...
{
  if(nIDEvent == (UINT)(UINT_PTR) this) // Use object's unique address as timer identifier
  {
// A..... Refresh the text and the progress bar
