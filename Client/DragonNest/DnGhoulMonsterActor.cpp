...
CDnGhoulMonsterActor::CDnGhoulMonsterActor( int nClassID, bool bProcess )
...
void CDnGhoulMonsterActor::OnDamage( CDnDamageBase *pHitter, SHitParam &HitParam )
{
	CDnSimpleRushMonsterActor::OnDamage( pHitter, HitParam );
