...
TDnPlayerLencea< CDnPlayerActor >::RotateBoneStruct TDnPlayerLencea< CDnPlayerActor >::s_RotateBoneDefine[] = { 
...
CDnNLPALencea::CDnNLPALencea( int nClassID, bool bProcess )
: TDnPlayerLencea< CDnPlayerActor >( nClassID, bProcess )
{
	m_fPitchDelta = 0.f;
...
CDnNLPALencea::~CDnNLPALencea()
{
}

void CDnNLPALencea::Process( LOCAL_TIME LocalTime, float fDelta )
{
	TDnPlayerLencea< CDnPlayerActor >::Process( LocalTime, fDelta );
...
void CDnNLPALencea::OnDispatchMessage( DWORD dwActorProtocol, BYTE *pPacket )
{
	...
	TDnPlayerLencea< CDnPlayerActor >::OnDispatchMessage( dwActorProtocol, pPacket );
}
