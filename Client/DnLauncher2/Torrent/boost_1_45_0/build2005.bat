...
bjam --prefix=%cd%\..\..\.. --toolset=msvc-8.0 --build-type=complete link=static runtime-link=static
bjam --prefix=%cd%\..\..\.. --toolset=msvc-8.0 --build-type=complete link=static runtime-link=shared
popd
rmdir /s /q stage
rmdir /s /q boost
