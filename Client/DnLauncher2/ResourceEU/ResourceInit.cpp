...
void InitCtrlRect()
{
	...
	WCHAR*	szFileName			= DNCTRLDATA.GetMulitiLanguageFilePath();
	DNCTRLDATA.SetControlDataFromResource(nCurrentResourceID/*IDR_XML_CONTROL_DATA*/, szFileName/*_T("ControlPositionList.xml")*/, g_CtrlRect, MAX_CTRL_NUM);
