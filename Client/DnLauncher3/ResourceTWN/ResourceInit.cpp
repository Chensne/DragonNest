...
void InitCtrlRect()
{
	...
	g_CtrlRect[17].SetRect( 113, 537, 126, 550 );	// CheckBox_UseAgreement
	g_CtrlRect[18].SetRect( 130, 537, 280, 552 );	// Text_UseAgreement
	g_CtrlRect[19].SetRect( 280, 537, 430, 552 );	// Text_UseAgreementLink
	*/
}
