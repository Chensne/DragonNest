...
//////////////////////////////////////////////////////////////////////////
// 惫啊喊 沥狼 (府家胶 扼捞宏矾府 棺 PatchConfigList 沥焊)

//	_USE_COMMAND_LINE			// 目盖靛扼牢父 荤侩
//	_USE_SINGLE_CLIENT			// 教臂 努扼捞攫飘父 瘤盔
//	_USE_PARTITION_SELECT		// 颇萍记 急琶 扁瓷 瘤盔
//	_USE_MULTILANGUAGE			// 促惫绢 瘤盔
//	_USE_SPLIT_COMPRESS_FILE	// 盒且 拘绵(RAR) 颇老 促款肺靛 瘤盔
	...
	// URL 沥狼
	#define	PATCHCONFIG_LIST_URL	_T( "http://actoz.dn.nowcdn.co.kr/ClientPatch/Release_Client/" ) // 扼捞宏侩.
	//#define	PATCHCONFIG_LIST_URL	_T( "http://actoz.dn.nowcdn.co.kr/ClientPatch/Test_Client/" ) // 抛胶飘侩.
	#define	PATCHCONFIG_LIST		_T( "PatchConfigList.xml" )
#elif defined(_JPN)
	#define _USE_SINGLE_CLIENT
